	...
	$(document).ready(function() {
		...
		window.AppView = Backbone.View.extend({
			...
			addSessionLi: function (model) {
				...
				$("#sessions-list").append('<tr id="' + sessionId + '"><td><a href="/inspector/devtools.html?ws=localhost:8080/devtools/page/' + sessionId + '">' + sessionId + '</a></td><td>from ' + model.get("remoteEndpoint").join(":") + '</td><td>SDK: ' + model.get("sdkVersion") + '</td><td><i class="icon-chevron-right"></i></td></tr>');
			},
