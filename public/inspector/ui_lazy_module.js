...
{child.parent=this;child.dataGrid=this.dataGrid;this.children.splice(index,0,child);child.recalculateSiblings(index);if(this._expanded)
...
child.previousSibling.nextSibling=child.nextSibling;if(child.nextSibling)
child.nextSibling.previousSibling=child.previousSibling;if(this._expanded)
...
{if(!this._expanded)
return;this._expanded=false;this.dataGrid.scheduleUpdateStructure();},expand:function()
{if(this._expanded)
return;this._expanded=true;this.dataGrid.scheduleUpdateStructure();},willAttach:function(){},attached:function()
